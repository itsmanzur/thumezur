...
class Themezur_Options {
		...
		return array(
			...
			'header'      => array(
				...
				'middle'      => array(
					...
					'show_hamburger'        => true,
					'hide_mobile_hamburger' => false,
					'hide_desktop_hamburger'=> false,
					'show_button'           => false,
	...
	private static function sanitize_header_middle( array $raw, array $d ) {
		...
		return array(
			...
			'menu_position'        => in_array( $raw['menu_position'] ?? '', array( 'left', 'center', 'right' ), true ) ? $raw['menu_position'] : 'center',
			'hide_mobile_menu'     => ! empty( $raw['hide_mobile_menu'] ),
			'hide_desktop_menu'    => ! empty( $raw['hide_desktop_menu'] ),
			'show_hamburger'       => ! empty( $raw['show_hamburger'] ),
			'hide_mobile_hamburger' => ! empty( $raw['hide_mobile_hamburger'] ),
			'hide_desktop_hamburger' => ! empty( $raw['hide_desktop_hamburger'] ),
